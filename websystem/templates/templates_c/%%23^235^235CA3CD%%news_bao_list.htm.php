<?php /* Smarty version 2.6.14, created on 2007-01-09 10:07:40
         compiled from news_bao_list.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'light_keyword', 'news_bao_list.htm', 19, false),)), $this); ?>
  ...
  <tr>
    ...
    <table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="datalist">
      <tr class="title">
        ...
        <th width="298" align="center" bgcolor="#D8E0E5"><a href="<?php echo $this->_tpl_vars['sort_news_title']; ?>
">订单号</a></th>
        <th width="168" align="center" bgcolor="#D8E0E5"><a href="<?php echo $this->_tpl_vars['sort_posttime']; ?>
">录入时间</a></th>
        <th width="193" align="center" bgcolor="#D8E0E5"><a href="<?php echo $this->_tpl_vars['sort_author']; ?>
">录入作者</a></th>
        <th width="106" align="center" bgcolor="#D8E0E5"><a href="<?php echo $this->_tpl_vars['sort_confirm']; ?>
">状态</a></th>
        </tr>
...
" /></td>
        <td align="left">&nbsp;<a href="news_bao_edit.php?<?php echo $this->_tpl_vars['sort_url_param']; ?>
...
" title="点击编辑该记录"><?php echo ((is_array($_tmp=$this->_tpl_vars['row_result'][$this->_sections['sec']['index']]['news_title'])) ? $this->_run_mod_handler('light_keyword', true, $_tmp, $this->_tpl_vars['search_key']) : light_keyword($_tmp, $this->_tpl_vars['search_key'])); ?>
        ...
        <td align="center"><span class=<?php if ($this->_tpl_vars['row_result'][$this->_sections['sec']['index']]['confirm']): ?>"green">已通过<?php else: ?>"gray">进行中<?php endif; ?></span></td>
        </tr>
      <?php endfor; endif; ?>
      <tr bgcolor="#F0F0F0">
        <td colspan="5">
...
<div class="formControl">
  <input type="button" name="submit" value="添加" class="button" onclick="location.href='news_bao_add.php?<?php echo $this->_tpl_vars['sort_url_param']; ?>
&page=<?php echo $this->_tpl_vars['curr_page']; ?>
';" />
