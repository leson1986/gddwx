<?php /* Smarty version 2.6.14, created on 2013-01-10 13:44:23
         compiled from products_list.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'light_keyword', 'products_list.htm', 20, false),)), $this); ?>
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="maintable">
  <tr>
    <th align="left"><div class="thead">列表</div></th>
  </tr>
  <tr>
    <td>
    <table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="datalist">
      <tr class="title">
        <th  align="center" bgcolor="#D8E0E5">选中</th>
       <th align="center" bgcolor="#D8E0E5"><a href="<?php echo $this->_tpl_vars['sort_class_name']; ?>
">类别</a></th>
        <th  align="center" bgcolor="#D8E0E5"><a href="<?php echo $this->_tpl_vars['sort_products_desc']; ?>
">型号</a></th>
        <th  align="center" bgcolor="#D8E0E5"><a href="<?php echo $this->_tpl_vars['sort_products_pubtime']; ?>
">发布时间</a></th>
        <th  align="center" bgcolor="#D8E0E5"><a href="<?php echo $this->_tpl_vars['sort_products_index']; ?>
">首页</a></th>
        <th  align="center" bgcolor="#D8E0E5"><a href="<?php echo $this->_tpl_vars['sort_products_isvalid']; ?>
">有效</a></th>
        </tr>
...
" /></td>
        ...
        <td align="center"><a href="products_edit.php?<?php echo $this->_tpl_vars['sort_url_param']; ?>
&page=<?php echo $this->_tpl_vars['curr_page']; ?>
&id=<?php echo $this->_tpl_vars['row_result'][$this->_sections['sec']['index']]['id']; ?>
" title="点击编辑该记录"><?php echo ((is_array($_tmp=$this->_tpl_vars['row_result'][$this->_sections['sec']['index']]['products_desc'])) ? $this->_run_mod_handler('light_keyword', true, $_tmp, $this->_tpl_vars['search_key']) : light_keyword($_tmp, $this->_tpl_vars['search_key'])); ?>
</a></td>
        <td align="center"><?php echo $this->_tpl_vars['row_result'][$this->_sections['sec']['index']]['products_pubtime']; ?>
</td>
        <td align="center"><span class=<?php if ($this->_tpl_vars['row_result'][$this->_sections['sec']['index']]['products_istop']): ?>"green">是<?php else: ?>"gray">否<?php endif; ?></span></td>
...
<div class="formControl">
  <input type="button" name="submit" value="添加" class="button" onclick="location.href='products_add.php?<?php echo $this->_tpl_vars['sort_url_param']; ?>
&page=<?php echo $this->_tpl_vars['curr_page']; ?>
';" />
