<?php /* Smarty version 2.6.14, created on 2013-01-10 13:44:31
         compiled from products_edit.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'checked', 'products_edit.htm', 17, false),array('modifier', 'correct_path', 'products_edit.htm', 38, false),)), $this); ?>
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="maintable">
  ...
  <tr>
    ...
    <table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="datalist">
      <tr bgcolor="#FFFFFF">
        <td width="80" align="center">所属类</td>
...
" size="40"/>
          <input type="checkbox" name="products_istop" value="1" <?php echo ((is_array($_tmp=$this->_tpl_vars['products_istop'])) ? $this->_run_mod_handler('checked', true, $_tmp, 1) : checked($_tmp, 1)); ?>
 />
          首页显示</td>
      </tr>
      <tr bgcolor="#FFFFFF">
...
" size="40"/></td>
      ...
      <tr bgcolor="#FFFFFF">
        ...
        <td align="left"><input name="products_desc" type="text" value="<?php echo $this->_tpl_vars['products_desc']; ?>
" size="40"/></td>
      </tr>
      <tr bgcolor="#FFFFFF">
        <td align="center">产品编号(EN)</td>
        <td align="left"><input name="products_desc_en" type="text" value="<?php echo $this->_tpl_vars['products_desc_en']; ?>
" size="40"/></td>
      </tr>
      <tr bgcolor="#FFFFFF">
        <td align="center">产品排序</td>
        <td align="left"><input name="products_index" type="text" value="<?php echo $this->_tpl_vars['products_index']; ?>
" size="8"/></td>
      </tr>
      <tr bgcolor="#FFFFFF">
...
" size="50" />
      ...
      <!--<tr bgcolor="#FFFFFF">
        ...
        <td align="left">
<textarea name="products_desc" id="products_desc" class="hide_textarea"><?php echo ((is_array($_tmp=$this->_tpl_vars['products_desc'])) ? $this->_run_mod_handler('correct_path', true, $_tmp) : correct_path($_tmp)); ?>
</textarea>
<iframe src="fck2/editor/fckeditor.html?InstanceName=products_desc&amp;Toolbar=Custom" width="100%" height="350" frameborder="no" scrolling="No"></iframe></td>
      ...
      <tr bgcolor="#FFFFFF">
        ...
        <td align="left">
<textarea name="products_desc_en" id="products_desc_en" class="hide_textarea"><?php echo ((is_array($_tmp=$this->_tpl_vars['products_desc_en'])) ? $this->_run_mod_handler('correct_path', true, $_tmp) : correct_path($_tmp)); ?>
</textarea>
