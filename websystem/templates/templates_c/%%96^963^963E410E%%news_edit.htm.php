<?php /* Smarty version 2.6.14, created on 2011-05-18 12:51:52
         compiled from news_edit.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'checked', 'news_edit.htm', 21, false),array('modifier', 'correct_path', 'news_edit.htm', 27, false),)), $this); ?>
...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" class="maintable">
  ...
  <tr>
    ...
    <table width="750" border="0" align="center" cellpadding="0" cellspacing="0" class="datalist">
      <tr bgcolor="#FFFFFF">
        <td width="80" align="center">文档标题</td>
        <td align="left"><input name="news_title" type="text" class="text" value="<?php echo $this->_tpl_vars['news_title']; ?>
" size="80" /></td>
      </tr>
      <tr bgcolor="#FFFFFF">
        <td width="80" align="center">文档标题(EN)</td>
        <td align="left"><input name="news_title_en" type="text" class="text" value="<?php echo $this->_tpl_vars['news_title_en']; ?>
" size="80" /></td>
      </tr>
      <tr bgcolor="#FFFFFF">
 ...
 />未审核
      ...
      <tr bgcolor="#FFFFFF">
        <td align="center">文档内容(EN)</td>
        <td align="left"><textarea name="news_content_en" id="news_content_en" class="hide_textarea"><?php echo ((is_array($_tmp=$this->_tpl_vars['news_content_en'])) ? $this->_run_mod_handler('correct_path', true, $_tmp) : correct_path($_tmp)); ?>
</textarea>
        <iframe src="fck2/editor/fckeditor.html?InstanceName=news_content_en&amp;Toolbar=Custom" width="100%" height="350" frameborder="no" scrolling="No"></iframe></td>
      </tr>
      <tr bgcolor="#FFFFFF">
