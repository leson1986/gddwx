<?php /* Smarty version 2.6.14, created on 2010-09-09 11:32:21
         compiled from case_class_edit.htm */ ?>
<style type="text/css">
...
" size="40" /></td>
          ...
          <tr>
            <td align="center">菜单名称(EN)</td>
            <td><input name="class_name_en" type="text" class="text" value="<?php echo $this->_tpl_vars['class_name_en']; ?>
" size="40" /></td>
          </tr>
        </table></td>
    </tr>
