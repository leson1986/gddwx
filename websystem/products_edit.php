<?php
    ...
    $page_type    = "edit";
    $display_page = "products_edit.htm";
    $table_name   = "{$tablepre}products";
    $condition    = "WHERE `id`='{$id}'";
    $back_page    = "products_list.php?sortby={$_GET['sortby']}&oexp={$_GET['oexp']}&page={$_GET['page']}&products_classid={$_GET['products_classid']}&keyword={$_GET['keyword']}";
