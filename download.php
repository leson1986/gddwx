<?php
    ...
    $plist->Execute("select P.*,C.class_name_en from `{$tablepre}case` as P,`{$tablepre}case_class` as C where C.id = P.products_classid and `products_classid`={$classid} and `products_isvalid` = 1");
	$plist->TplParse();
