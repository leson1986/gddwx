...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'correct_path', 'contact.html', 15, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
     ...
     <div class="right">
      ...
      <div id="gd_pro_l"><img src="images/HaoSc23.png" width="18" height="18" /><span>CONTACT US</span></div>
      <div id="gd_pro_r"></div>
      <div id="cl"></div>
      <div id="line_1"></div>
      <div id="gd_pro">
