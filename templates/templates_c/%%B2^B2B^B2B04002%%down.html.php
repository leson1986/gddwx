          ...
          <tr>
            <td height="20">
              <div align="center">
                ...
                <a href="download.php?menuid=7&classid=<?php echo $this->_tpl_vars['down_class'][$this->_sections['case']['index']]['id']; ?>
" class="left_menu"><?php echo $this->_tpl_vars['down_class'][$this->_sections['case']['index']]['class_name_en']; ?>
</a></div></td>
          </tr>
		  <?php endfor; endif; ?>
        </table>