...
"><?php echo $this->_tpl_vars['cat']['class_name_en']; ?>
</option>
...
">&nbsp;-<?php echo $this->_tpl_vars['catr']['class_name_en']; ?>
</option>
...
?>
					...
					<li class="sm11"><a href="products.php?classid=<?php echo $this->_tpl_vars['cat']['id']; ?>
&menuid=3" class="left_menu2"><strong><?php echo $this->_tpl_vars['cat']['class_name_en']; ?>
</strong></a></li>
					<?php $_from = $this->_tpl_vars['cat']['child']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['r'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['r']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['catr']):
        $this->_foreach['r']['iteration']++;
?>
							<li class="sm22"><IMG src="images/arrow_6.gif" width=11 height="11">&nbsp;<a href="products.php?classid=<?php echo $this->_tpl_vars['catr']['id']; ?>
&menuid=3"><?php echo $this->_tpl_vars['catr']['class_name_en']; ?>
</a></li>
					<?php endforeach; endif; unset($_from); ?>
					<?php endforeach; endif; unset($_from); ?>						
									<!--<li class="sm3"><a href="333">33</a></li>-->
          ...
          <TR>
            <TD 
                            height=1 colspan="2" 
                            background=images/naSzarym.gif><IMG height=1 src="images/1x1_pix.gif"  width=10></TD>
          </TR>
        </table>