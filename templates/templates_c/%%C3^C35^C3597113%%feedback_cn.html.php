...
unset($_smarty_tpl_vars);
 ?>
     ...
     <div class="right">
      ...
      <div id="gd_pro_l"><img src="images/HaoSc23.png" width="18" height="18" /><span>留言反馈</span></div>
      <div id="gd_pro_r"></div>
      <div id="cl"></div>
      <div id="line_1"></div>
      <div id="gd_pro">
...
<tr>
          ...
          <tr>
            <td height="41">&nbsp;</td>
            <td>
              <input type="submit" name="button" id="button" value="提交" class="btn" />&nbsp;&nbsp;<input type="reset" name="Reset" id="button" value="清除" class="btn" />
