<?php /* Smarty version 2.6.14, created on 2013-01-25 15:48:22
         compiled from search_cn.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'correct_path', 'search_cn.html', 23, false),array('modifier', 'getThumb', 'search_cn.html', 23, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
     ...
     <div class="right">
      ...
      <div id="gd_pro_l"><img src="images/HaoSc23.png" width="18" height="18" /><span>产品展示</span></div>
      <div id="gd_pro_r"></div>
      <div id="cl"></div>
      <div id="line_1"></div>
      <div id="gd_pro">
...
&classid=<?php echo $this->_tpl_vars['product'][$this->_sections['p']['index']]['products_classid']; ?>
"><span class="fb">产品型号:</span> <?php echo $this->_tpl_vars['product'][$this->_sections['p']['index']]['products_desc']; ?>
</a>
							<a href="products_detail_cn.php?menuid=3&id=<?php echo $this->_tpl_vars['product'][$this->_sections['p']['index']]['id']; ?>
&classid=<?php echo $this->_tpl_vars['product'][$this->_sections['p']['index']]['products_classid']; ?>
"><span class="fb">产 品 名: </span><?php echo $this->_tpl_vars['product'][$this->_sections['p']['index']]['products_name']; ?>
</a>
							<a href="products_detail_cn.php?menuid=3&id=<?php echo $this->_tpl_vars['product'][$this->_sections['p']['index']]['id']; ?>
&classid=<?php echo $this->_tpl_vars['product'][$this->_sections['p']['index']]['products_classid']; ?>
