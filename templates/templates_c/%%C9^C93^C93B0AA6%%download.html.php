<?php /* Smarty version 2.6.14, created on 2013-01-09 00:51:43
         compiled from download.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'correct_path', 'download.html', 19, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ...
 <!--头部结束-->
   <div id="ind_center">
     <div class="left">
	 <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "down.html", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
	 </div>
     <div class="right">
      ...
      <div id="gd_pro_l"><img src="images/HaoSc23.png" width="18" height="18" /><span>DOWNLOAD</span></div>
      <div id="gd_pro_r"></div>
      <div id="cl"></div>
      <div id="line_1"></div>
      <div id="gd_pro">
...
?>  
    <tr>
      <td width="87%" height="26"><img src="images/down_01.gif" width="28" height="10" /><?php echo $this->_tpl_vars['down'][$this->_sections['cases']['index']]['products_name_en']; ?>
</td>
      <td width="13%"><a  href="<?php echo ((is_array($_tmp=$this->_tpl_vars['down'][$this->_sections['cases']['index']]['products_thumb_en'])) ? $this->_run_mod_handler('correct_path', true, $_tmp) : correct_path($_tmp)); ?>
