...
function get_categories_tree($cat_id = 0)
{
    ...
    */
    ...
    $plist->Execute("select C.class_name,P.* from `{$tablepre}products` as P,`{$tablepre}products_class` as C where C.id = P.products_classid ".$where." and `products_isvalid` = 1 order by P.`products_index`");
	$plist->TplParse();
